...
using MicroServiceA.Extensions;
using MicroServiceA.LocationServices;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.Run(async (context) =>
            {
                ...
                {
                    var forecast = new LocationService(latitude.Value, longitude.Value, 10);
                ...
                else
                {
                    ...
                    await context.Response.WriteAsync($"Unable to get locaton of  lat: {latitude}, long: {longitude}");
                }
